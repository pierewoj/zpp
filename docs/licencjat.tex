...
\chapter{Implemented binarization algorithms}
	\section{Binarized convolution filters from XORNET \cite{xornet}}
		...
		\section{Binarized convolution filters inspired by DoReFa \cite{dorefa}}
...
\chapter{Binarized vs standard network accuracy}
	...
	\section{AlexNet on Flowers}
		...
		\subsection{Fine-tuning results and discussion}
	            ...
	            \begin{figure}[h]
				\centering
				\includegraphics[width=\textwidth]{images/Finetuning-AlexNet-on-flowers102}
			\end{figure}
		        \paragraph{Discussion} 
